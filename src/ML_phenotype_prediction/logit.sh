...
#SBATCH --output=/scratch/users/briannac/logs/logit.out
#SBATCH --error=/scratch/users/briannac/logs/logit.err
#SBATCH --time=3:00:00
#SBATCH --mem=500G
...
for biomarker in taxa asv otu90 otu95 otu97 otu99 micropheno4 micropheno6 micropheno8 sbb1 sbb2 sbb3; do
    for dataset in autism obesity; do
        ...
        python3.6 -u $MY_HOME/sequence_based_biomarkers/src/ML_phenotype_prediction/logit.py $dataset $biomarker
    done
done
