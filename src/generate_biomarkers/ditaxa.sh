...
for study in yogurt; do #obese_lean_twins diabetes_150; do
    for msa_method in DECIPHER; do
        ...
        for order in 1; do #2 3; do
            ...
            python3.6 src/generate_SBBs/generate_higher_order_biomarkers.py $order data/${study}/person_vs_taxa.tsv data/${study}/${msa_method}_taxa_vs_variants_unique.tsv results/generate_SBBs/${study}_${msa_method}_
